...
Elm.Main.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = function (game) {    return A2($Html.section,_U.list([]),_U.list([$Html.text($Basics.toString(game.id))]));};
   var initialGame = {id: 1};
   var main = view(initialGame);
   var Game = function (a) {    return {id: a};};
   return _elm.Main.values = {_op: _op,Game: Game,initialGame: initialGame,main: main,view: view};
};
